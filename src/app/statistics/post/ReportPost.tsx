...
import { Card, CardContent, Typography, Button, Avatar, Box, Paper, Divider } from '@mui/material'
...
export default function ReportPost() {
    ...
    const handleNext = () => {
        const nextSlide = currentSlide + 1 >= mockReportList.length ? mockReportList.length - 1 : currentSlide + 1
                            ...
                            >
                                <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: 2 }}>
                                    ...
                                    <Box>
                                        ...
                                        >
                                            {t('COMMON.DASHBOARD.POSTED')} {formatDate(report.createdAt)}
                                        </Typography>
                                    </Box>
                                </Box>
